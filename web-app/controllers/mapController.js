	...
	$scope.addAnnotation = function() {
        olData.getMap().then(function(map) {
            olData.getLayers().then(function(layers) {
            	setFeature(createAnnotationFeature(annotation), layers.annotationMarker);
            });
        });
    };
