...
iris.controller("termTreeCtrl", 
		["$rootScope", "$scope", "$timeout", "$log", "sessionService", "projectService", "sharedService", "$routeParams",
		function($rootScope, $scope, $timeout, $log, sessionService, projectService, sharedService, $routeParams){
	...
	projectService.fetchOntologyByProjectID($scope.projectID, null, function(ontology){
